...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main$body() {
      var $async$goto = 0,
        ...
        satunnaisindeksi, kysymys, t1, t2, kysymykset, t3, enimmaispisteet, pisteetKappale, $async$temp1, $async$temp2, $async$temp3;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              kysymykset = $async$temp1._as($async$temp2._as($async$temp3.decode$2$reviver(0, $async$result, null)).$index(0, "kysymykset"));
              t3 = J.getInterceptor$asx(kysymykset);
              enimmaispisteet = t3.get$length(kysymykset);
              pisteetKappale = document.createElement("p");
              B.ParagraphElement_methods.set$text(pisteetKappale, "pisteesi: " + $.pelaajanPisteet + " / " + enimmaispisteet);
              $.$get$pisteetAlue().appendChild(pisteetKappale);
              satunnaisindeksi = B.C__JSRandom.nextInt$1(t3.get$length(kysymykset));
              t1.satunnaisindeksi = satunnaisindeksi;
              kysymys = t2._as(t3.$index(kysymykset, satunnaisindeksi));
              t1.kysymys = kysymys;
              A.asetaKysymys(kysymys, enimmaispisteet);
              t2 = $.$get$seuraavaKysymysPainike();
              t3 = type$._ElementEventStreamImpl_MouseEvent;
              t1 = t3._eval$1("~(1)?")._as(new A.main_closure(t1, kysymykset, enimmaispisteet));
              type$.nullable_void_Function._as(null);
              A._EventStreamSubscription$(t2, "click", t1, false, t3._precomputed1);
              // implicit return
    ...
    asetaKysymys(kysymys, enimmaispisteet) {
      A.tulostaNaytolle(A._asString(kysymys.$index(0, "teksti")), type$.List_dynamic._as(kysymys.$index(0, "vaihtoehdot")), enimmaispisteet);
    },
    tulostaNaytolle(teksti, luettelo, enimmaispisteet) {
      var t2, t3, kysymys, t4, t5, t6, t7, indeksi, vastausvaihtoehto, vastausvaihtoehdonTeksti, oikein, vastausvaihtoehtoNaytolla, t8,
        t1 = $.$get$kysymysalue();
      B.DivElement_methods._clearChildren$0(t1);
      t2 = $.$get$vastausvaihtoehtoalue();
      B.DivElement_methods._clearChildren$0(t2);
      t3 = document;
      kysymys = t3.createElement("h4");
      B.HeadingElement_methods.set$text(kysymys, teksti);
      t1.appendChild(kysymys);
      t1 = J.getInterceptor$ax(luettelo);
      t1.shuffle$0(luettelo);
      for (t4 = type$.Map_dynamic_dynamic, t5 = type$._ElementEventStreamImpl_MouseEvent, t6 = t5._eval$1("~(1)?"), t7 = type$.nullable_void_Function, t5 = t5._precomputed1, indeksi = 0; indeksi < t1.get$length(luettelo); ++indeksi) {
        vastausvaihtoehto = t4._as(t1.$index(luettelo, indeksi));
        vastausvaihtoehdonTeksti = A._asString(vastausvaihtoehto.$index(0, "teksti"));
        oikein = A._asBool(vastausvaihtoehto.$index(0, "oikein"));
        vastausvaihtoehtoNaytolla = t3.createElement("p");
        vastausvaihtoehtoNaytolla.className = "vastausvaihtoehto";
        B.ParagraphElement_methods.set$text(vastausvaihtoehtoNaytolla, vastausvaihtoehdonTeksti);
        t2.appendChild(vastausvaihtoehtoNaytolla);
        t8 = t6._as(new A.tulostaNaytolle_closure(oikein, vastausvaihtoehtoNaytolla, enimmaispisteet));
        t7._as(null);
        A._EventStreamSubscription$(vastausvaihtoehtoNaytolla, "click", t8, false, t5);
      }
    },
    main_closure: function main_closure(t0, t1, t2) {
      this._box_0 = t0;
      this.kysymykset = t1;
      this.enimmaispisteet = t2;
    },
    tulostaNaytolle_closure: function tulostaNaytolle_closure(t0, t1, t2) {
      this.oikein = t0;
      this.vastausvaihtoehtoNaytolla = t1;
      this.enimmaispisteet = t2;
    },
  ...
  A.main_closure.prototype = {
    call$1(napsautus) {
      var t1, t2, t3, t4, poistettavaKysymys, satunnaisindeksi, kysymys;
      type$.MouseEvent._as(napsautus);
      t1 = this.kysymykset;
      t2 = this._box_0;
      t3 = J.getInterceptor$ax(t1);
      t4 = type$.Map_dynamic_dynamic;
      poistettavaKysymys = t4._as(t3.$index(t1, t2.satunnaisindeksi));
      t3.remove$1(t1, poistettavaKysymys);
      satunnaisindeksi = B.C__JSRandom.nextInt$1(t3.get$length(t1));
      t2.satunnaisindeksi = satunnaisindeksi;
      kysymys = t4._as(t3.$index(t1, satunnaisindeksi));
      t2.kysymys = kysymys;
      A.asetaKysymys(kysymys, this.enimmaispisteet);
      t3.add$1(t1, poistettavaKysymys);
    },
    $signature: 18
  };
  A.tulostaNaytolle_closure.prototype = {
    call$1(napsautus) {
      var pisteetKappale, _this = this,
        t1 = _this.vastausvaihtoehtoNaytolla;
      if (_this.oikein) {
        t1.className = "oikeaVastaus";
        B.ParagraphElement_methods.set$text(t1, "Oikein!");
        t1 = $.pelaajanPisteet;
        if (t1 >= _this.enimmaispisteet)
          $.pelaajanPisteet = 1;
        else
          $.pelaajanPisteet = t1 + 1;
      } else {
        t1.className = "vaaraVastaus";
        B.ParagraphElement_methods.set$text(t1, "V\xe4\xe4rin.");
      }
      t1 = $.$get$pisteetAlue();
      B.DivElement_methods._clearChildren$0(t1);
      pisteetKappale = document.createElement("p");
      B.ParagraphElement_methods.set$text(pisteetKappale, "pisteesi: " + $.pelaajanPisteet + " / " + _this.enimmaispisteet);
      t1.appendChild(pisteetKappale);
    },
    $signature: 4
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A.StreamTransformerBase, A._StreamIterator, A._Zone, A.ListMixin, A.MapMixin, A.Codec, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A.ImmutableListMixin, A.FixedSizeListIterator, A._JSRandom]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.ButtonElement, A.DivElement, A.FormElement, A.HeadingElement, A.ParagraphElement, A.SelectElement]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "Null(@)", "Null()", "~(Event)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "~(@)", "Null(@,StackTrace)", "~(int,@)", "~(Object[StackTrace?])", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?,Object?)", "String(HttpRequest)", "~(ProgressEvent)", "~(MouseEvent)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"Element","GraphicsElement":"Element","SvgElement":"Element","_ResourceProgressEvent":"ProgressEvent","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSNumNotInt":{"num":[]},"JSString":{"String":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"LinkedHashMapKeyIterable":{"Iterable":["1"]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_AsyncCompleter":{"_Completer":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"_JsonMap":{"MapMixin":["String","@"],"Map":["String","@"],"MapMixin.K":"String","MapMixin.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"Iterable":["String"],"ListIterable.E":"String"},"JsonDecoder":{"Converter":["String","Object?"]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"HttpRequest":{"EventTarget":[]},"MouseEvent":{"Event":[]},"Node":{"EventTarget":[]},"ProgressEvent":{"Event":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"ButtonElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"DivElement":{"Element":[],"Node":[],"EventTarget":[]},"Element":{"Node":[],"EventTarget":[]},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"HeadingElement":{"Element":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListMixin.E":"Node","ImmutableListMixin.E":"Node"},"HttpRequestEventTarget":{"EventTarget":[]},"ParagraphElement":{"Element":[],"Node":[],"EventTarget":[]},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"UIEvent":{"Event":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]}}'));
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "kysymysalue", "$get$kysymysalue", () => A.findType("DivElement")._as(A.querySelector("#kysymysalue")));
    _lazyFinal($, "vastausvaihtoehtoalue", "$get$vastausvaihtoehtoalue", () => A.findType("DivElement")._as(A.querySelector("#vastausvaihtoehtoalue")));
    _lazyFinal($, "seuraavaKysymysPainike", "$get$seuraavaKysymysPainike", () => A.findType("ButtonElement")._as(A.querySelector("#seuraavaKysymysPainike")));
    _lazyFinal($, "pisteetAlue", "$get$pisteetAlue", () => A.findType("DivElement")._as(A.querySelector("#pisteetAlue")));
  })();
